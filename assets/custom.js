...
$(".faq-item").each(function () {
  $(this).click(function () {
    if ($(this).hasClass("open-tab")) {
      $(document).find(".close-tab").removeClass("close-tab").addClass("open-tab");
      $(document).find(".faq-answer").css({
        "max-height": "0",
        "margin-top": "8px"
      });
      $(this).removeClass("open-tab").addClass("close-tab");
      var t = $(this).find(".faq-answer").prop("scrollHeight");
      $(this).find(".faq-answer").css({
        "max-height": "100%"
      });
    } else {
      $(this).removeClass("close-tab").addClass("open-tab"), $(this).find(".faq-answer").css({
        "max-height": "0",
        "margin-top": "0px"
      });
    }
...
$('.product-item-photo img').each(function () {
  $(this).hover(function () {
    ...
    $(this).closest('img').find('.img-hover').show();
    $(this).closest('img').find('.img-nonhover').hide();
...
function updateDrawer() {
  $.get("/", function (data) {
    ...
    const totalItems = doc.querySelector("cart-drawer").getAttribute('data-total');
    ...
    document.querySelector(".drawer-body").innerHTML = drawerSelector;
    document.querySelector('.drawer-header p').innerHTML = 'Product added to cart';
    document.querySelector('.drawer__footer').style.display = 'block';
  });
}
